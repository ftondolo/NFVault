...
AES128 aes128;
byte key[16];
byte passwords[1][16] =  {{0x3C, 0x03, 0x8D, 0x8C, 0x16, 0x7E, 0xAC, 0xB4, 0x59, 0xFB, 0xC5, 0x71, 0x6D, 0x5A, 0xC3, 0x38},
...
void loop() 
{
  // if ((((millis()-last_login)/1000)%sleep_timeout < 10) && !just_logged_in){
  //   is_locked = 1;
